  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      >
        ...
        >
          <Box>
            <Stack direction="column">
              ...
              >
                {shows.name || shows.original_name}
              </Typography>
              <Stack direction="row" gap="10px" alignItems="center">
                ...
                {/* <Typography variant='p' sx={{color:"#afa8a8", fontSize:"14px", fontWeight:'bold'}}>
          ...
          >
            ...
            >
              <CardMedia
                component="img"
                height="194"
                image={`https://image.tmdb.org/t/p/original${shows.poster_path}`}
                alt={shows.title}
        ...
        <Box id="tvDetailsSection" sx={{ marginTop: "10px", width: "100%" }}>
          <Stack sx={{ flexDirection: { xs: "row" }, gap: { xs: "10px" } }}>
            ...
            >
              ...
              >
                {shows.genres !== undefined &&
                  shows.genres.map((ele, ind) => {
                    return (
                      <Chip
                        key={ind}
                        label={`${ele.name}`}
...
export default WrapperComponent(TvPage);
